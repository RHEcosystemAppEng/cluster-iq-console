...
import { AuditEvent } from '@app/types/types';
...
import { getResultIcon, capitalizeFirstLetter, ResultStatus } from '@app/utils/renderUtils';
      ...
      <Tbody>
        {data.map(event => (
          <Tr key={event.id}>
            ...
            <Td>
              {getResultIcon(event.result as ResultStatus)} {capitalizeFirstLetter(event.result)}{' '}
            </Td>
